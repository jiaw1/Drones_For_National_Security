...
public class MiniDroneController03 : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        // Force the drone to start by flying towards the third point (-40, 0, 40)
        currentPointIndex = 2; // Index of (-40, 0, 40) in the edgePoints array
    }
