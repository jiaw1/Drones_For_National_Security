...
public class MiniDroneController02 : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        edgePoints = new Vector3[]
        {
            ...
            new Vector3(transform.position.x, flyHeight, -40),
            new Vector3(-40, flyHeight, -40), // Bottom left
            new Vector3(-40, flyHeight, 40),  // Top left
            new Vector3(40, flyHeight, 40)    // Top right
        };

        // Force the drone to start by flying towards the second point (-40, 0, -40)
        currentPointIndex = 1; // Index of (-40, 0, -40) in the edgePoints array
    }
