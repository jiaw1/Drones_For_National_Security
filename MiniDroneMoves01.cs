...
public class MiniDroneController01 : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        // Force the drone to start by flying towards the first point (40, 0, -40)
        currentPointIndex = 0; // Index of (40, 0, -40) in the edgePoints array
    }
